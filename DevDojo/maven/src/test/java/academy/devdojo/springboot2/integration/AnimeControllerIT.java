...
class AnimeControllerIT {
    ...
    @Autowired
    private Robertosimo23UserRepository robertosimo23UserRepository;
    private static final Robertosimo23User USER = Robertosimo23User.builder()
            .name("Robertosimo23 Academy")
            .password("{bcrypt}$2a$10$nIBEIJH6Viyfyb6npka0GubJuec5ff7w2bLbdn2FWbbdD6U.K5ZQa")
            .username("robertosimo23")
            .authorities("ROLE_USER")
            .build();

    private static final Robertosimo23User ADMIN = Robertosimo23User.builder()
            .name("Roberto Simões")
            .password("{bcrypt}$2a$10$nIBEIJH6Viyfyb6npka0GubJuec5ff7w2bLbdn2FWbbdD6U.K5ZQa")
            .username("roberto")
    ...
    static class Config {
        ...
        public TestRestTemplate testRestTemplateRoleUserCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
                    ...
                    .basicAuthentication("robertosimo23", "academy");
        ...
        public TestRestTemplate testRestTemplateRoleAdminCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
                    .rootUri("http://localhost:"+port)
                    .basicAuthentication("roberto", "academy");
            return new TestRestTemplate(restTemplateBuilder);
        }
    }
    ...
    void list_ReturnsListOfAnimesInsidePageObject_WhenSuccessful() {
        ...
        robertosimo23UserRepository.save(USER);
    ...
    void delete_RemovesAnime_WhenSuccessful() {
        Anime savedAnime = animeRepository.save(AnimeCreator.createAnimeToBeSaved());
        robertosimo23UserRepository.save(ADMIN);
