...
public class ListaTarefa {
  ...
  public static void main(String[] args) {
    ...
    listaTarefa.adicionarTarefa("Comprar ração para a gata");
    listaTarefa.adicionarTarefa("Estudar para ser um Dev");
    listaTarefa.adicionarTarefa("Pensar no vazio da minha existência");
