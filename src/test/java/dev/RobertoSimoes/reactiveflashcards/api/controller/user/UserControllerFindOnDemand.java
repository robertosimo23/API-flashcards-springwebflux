...
import dev.RobertoSimoes.reactiveflashcards.core.factorybot.dto.UserPageDocumentFactoryBot;
...
import static dev.RobertoSimoes.reactiveflashcards.utils.request.RequestBuilder.userPageResponseRequestBuilder;
...
public class UserControllerFindOnDemand extends AbstractControllerTest {
    @MockBean
    ...
    void findOnDemandTest(final UserPageDocument pageDocument) {
        ...
        when(userQueryService.findOnDemand(any(UserPageRequest.class)))
                .thenReturn(Mono.just(pageDocument));
        userPageResponseRequestBuilder.uri(uriBuilder -> uriBuilder
                        .queryParam("page", queryParams.page())
                        .queryParam("limit", queryParams.page())
    ...
    private static Stream<Arguments> checkConstraintTest() {
        ...
        Function<UriBuilder, URI> invalidPage = uriBuilder -> uriBuilder
                ...
                .queryParam("sentence", invalidPageQueryParam.sortBy())
